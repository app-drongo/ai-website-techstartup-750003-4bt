...
const DEFAULT_FOOTER = {
  logoText: 'TechFlow',
  companyDescription:
    'Revolutionizing the future of web development with cutting-edge technology and innovative solutions. Join thousands of developers and startups who trust our platform to scale their digital presence.',
  ...
  newsletterDisclaimer:
    'Get exclusive updates on new features and tech insights. No spam, unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 TechFlow. All rights reserved.',
  madeWithText: 'with ❤️ by our team',
